...
The complete solution set contains 1,122,348 optimally wrong Wordle combinations, computed using Wordle's official answer list and extended guess vocabulary. These solutions are realized from a set of 565,783 packings.
